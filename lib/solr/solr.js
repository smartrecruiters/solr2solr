...
Client.prototype.get = function(getPath, callback) {
  ...
  winston.debug(`Query: ${options.path}`);
  this.request(options, callback || noop);
};

Client.prototype.atomicUpdate = function(data) {
  var options = {
    method: 'POST',
    url: "http://" + this.options.host + ':' + this.options.port + "/solr" + this.options.core + '/update',
    headers: {
...
Client.prototype.addDocument = function(doc, options, callback) {
  ...
  return request(optionsHttp);
};

Client.prototype.querySolr = function(query, options) {
  ...
  var optionsHttp = {
    method: 'GET',
    url: "http://" + this.options.host + ':' + this.options.port + "/solr" + this.options.core + '/select?' + querystring.stringify(queryParams),
    resolveWithFullResponse: true,
    json: true
